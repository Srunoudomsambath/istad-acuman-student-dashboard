...
export const studentProfile: Scholar = {
  ...
  status: "ACTIVE",
  bio: "A passionate software engineering student who enjoys building thoughtful digital products and learning from each internship experience.",
  ...
  enrollments: [
    ...
    {
      id: "enrollment-full-stack",
      source: "exstad",
      type: "scholarship",
      title: "Full Stack Scholarship",
      slug: "full-stack-scholarship",
      url: "/student/scholarships/full-stack-scholarship",
      status: "active",
    },
  ],
  completedCourses: [
  ...
  careers: [
    {
      ...
      salary: 800,
      interest: "Built responsive student-facing pages and collaborated closely with product and backend teams.",
      startDate: "Jan 2024",
      endDate: "Aug 2024",
    },
    {
      uuid: "career-digiflow",
      company: "DigiFlow Solutions",
      companyType: "Software Company",
      position: "UI Engineer Intern",
      salary: 650,
      interest: "Worked on reusable UI components, dashboard polishing, and usability improvements for internal tools.",
      startDate: "Sep 2024",
      endDate: "Present",
    },
  ],
