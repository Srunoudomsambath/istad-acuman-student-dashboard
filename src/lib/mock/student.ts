...
export const studentProfile: Scholar = {
  ...
  nickname: "chanchhhay",
  telegram: "t.me/chan_chhaya",
  facebook: "facebook.com/chanchhaya",
  github: "github.com/chanchhaya",
  website: "https://chanchhaya.dev",
  ...
  status: "ACTIVE",
  background:
    "Raised in Siem Reap and now studying in Phnom Penh, Chhaya enjoys building products that make learning easier for students moving between scholarship and degree programs.",
